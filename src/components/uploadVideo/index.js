...
export default {
  ...
  methods: {
      ...
      addLocalVideo(){
        ...
        let videoHtml='<p class="set_cursor_video"><br/></p><p contenteditable="false" style="text-align:center" class="video_container" serverfileid="'+this.video.videoId+'" id="id_video_container_'+this.video.videoId+'">'+this.$refs.videoPreview.innerHTML+'</p>'+'<a href="'+this.$store.state.videourl+'" contenteditable="false" download class="download_video" target="_blank" _href="'+ this.$store.state.videourl+'">下载视频</a>;
      ...
      addSourceVideo(){
          if(this.selVideoid!= '111'){
            ...
            let videoHtml='<p class="set_cursor_video"><br/></p><p contenteditable="false" style="text-align:center;width:100%;" class="video_container" serverfileid="'+this.selVideoid+'" id="id_video_container_'+this.selVideoid+'">'+this.$refs.videoPreview1.innerHTML+'</p>'+'<a href="'+this.$store.state.videourl+'" contenteditable="false" download class="download_video" target="_blank" _href="'+ this.$store.state.videourl+'">下载视频</a>;
